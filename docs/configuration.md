...
### Step 3: Measurements & Reachability (Optional)
...
### Step 4: Water Quality Sensors & Safety (Optional)
...
### Step 5: Maintenance Notifications (Optional)
...
### Step 7: Target Salt (Saltwater/Mixed Only)
- **Target Salt (g/L)**: Used as a baseline for effective TDS.

### Step 8: Chemistry Estimation (Simple Tuning)
...
### Step 9: Temperature Control (Thermostat)
...
### Step 10: Dynamic Target Temperature (Optional)
