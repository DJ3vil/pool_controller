...
CONF_BLUERIIOT_SALT_DIVISOR = "blueriiot_salt_divisor"
...
CONF_NOTIFY_SENSOR_HEALTH = "notify_sensor_health"
CONF_NOTIFY_WATER_QUALITY = "notify_water_quality"
...
DEFAULT_NOTIFY_SENSOR_HEALTH = True
DEFAULT_NOTIFY_WATER_QUALITY = True
DEFAULT_ENABLE_BLUERIIOT = False
DEFAULT_BLUERIIOT_SALT_DIVISOR = 18.0
...
# Dynamic target defaults (weather-led comfort curve)
DEFAULT_ENABLE_DYNAMIC_TARGET = False
DEFAULT_DYNAMIC_TARGET_WINTER_OFFSET = 2.0
DEFAULT_DYNAMIC_TARGET_SPRING_OFFSET = 1.0
DEFAULT_DYNAMIC_TARGET_SUMMER_OFFSET = -2.0
DEFAULT_DYNAMIC_TARGET_AUTUMN_OFFSET = 0.5
DEFAULT_DYNAMIC_TARGET_MIN_OFFSET = -5.0
DEFAULT_DYNAMIC_TARGET_MAX_OFFSET = 5.0
DEFAULT_DYNAMIC_TARGET_WEATHER_MAX_OFFSET = 3.0
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_TEMP = 1.00
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_FEELS_LIKE = 0.10
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_WIND = 0.10
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_UV = 0.15
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_CLOUD = 0.05
DEFAULT_DYNAMIC_TARGET_WEATHER_WEIGHT_FORECAST = 0.05
